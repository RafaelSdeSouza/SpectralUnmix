...
The package includes a validation workflow built around a noise-free low-rank
toy problem. The test suite checks exact recovery, benchmark-level agreement
with `NMF::nmf()`, and convergence diagnostics through `loss`, `niter_run`,
and `converged`.
